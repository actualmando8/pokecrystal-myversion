...
; Johto story events
	...
	const EVENT_GOT_TM57_WILL_O_WISP
	const EVENT_GOT_TM58_SCALD
	const EVENT_GOT_TM59_STEALTH_ROCK
	const EVENT_GOT_TM60_DRAGON_PULSE
	const EVENT_GOT_TM61_FLASH_CANNON
	const EVENT_GOT_TM62_DARK_PULSE
	const EVENT_GOT_TM63_POISON_JAB
	const EVENT_GOT_TM64_BUG_BUZZ
	const EVENT_RIVAL_POSTGAME_AVAILABLE
	const EVENT_RIVAL_REMATCH_1_COMPLETE
	const EVENT_RIVAL_REMATCH_2_COMPLETE
	const EVENT_RIVAL_REMATCH_3_COMPLETE
	const EVENT_BEAT_RIVAL_IN_ILEX_FOREST
	const EVENT_BEAT_RIVAL_IN_ROUTE_34
; Johto hidden items
