...
FalknerGroup:
	...
	db 11, SPEAROW,    PECK, LEER, FURY_ATTACK, NO_MOVE
	db 13, PIDGEOTTO,  GUST, SAND_ATTACK, QUICK_ATTACK, WING_ATTACK
	db -1 ; end

	; FALKNER (2) - Rematch
	db "FALKNER@", TRAINERTYPE_ITEM_MOVES
	db 56, PIDGEOT,    SHARP_BEAK,   WING_ATTACK, QUICK_ATTACK, MIRROR_MOVE, STEEL_WING
	db 54, FEAROW,     SHARP_BEAK,   DRILL_PECK, PURSUIT, MIRROR_MOVE, STEEL_WING
	db 55, DODRIO,     SHARP_BEAK,   DRILL_PECK, TRI_ATTACK, AGILITY, STEEL_WING
	db 56, NOCTOWL,    SHARP_BEAK,   WING_ATTACK, HYPNOSIS, DREAM_EATER, REFLECT
	db 58, SKARMORY,   LEFTOVERS,    STEEL_WING, DRILL_PECK, SPIKES, WHIRLWIND
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 18, CLEFAIRY,   DOUBLESLAP, ENCORE, FAIRY_WIND, METRONOME
	db 19, JIGGLYPUFF, SING, DEFENSE_CURL, DISARMING_VOICE, DOUBLESLAP
	db 20, SNUBBULL,   SCARY_FACE, CHARM, BITE, PLAY_ROUGH
	db 22, MILTANK,    ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end

	; WHITNEY (2) - Rematch
	db "WHITNEY@", TRAINERTYPE_ITEM_MOVES
	db 54, CLEFABLE,   LEFTOVERS,     MOONLIGHT, COSMIC_POWER, PSYCHIC_M, THUNDERBOLT
	db 55, WIGGLYTUFF, LEFTOVERS,     SING, DREAM_EATER, THUNDERBOLT, ICE_BEAM
	db 56, GRANBULL,   PINK_BOW,      PLAY_ROUGH, EARTHQUAKE, CRUNCH, HEAL_BELL
	db 56, BLISSEY,    LUCKY_EGG,     SOFTBOILED, TOXIC, SEISMIC_TOSS, THUNDER_WAVE
	db 58, MILTANK,    LEFTOVERS,     MILK_DRINK, BODY_SLAM, EARTHQUAKE, HEAL_BELL
	db -1 ; end
...
BugsyGroup:
	...
	db 16, LEDIAN,     COMET_PUNCH, LIGHT_SCREEN, REFLECT, SWIFT
	db 18, SCYTHER,    QUICK_ATTACK, LEER, FURY_CUTTER, WING_ATTACK
	db -1 ; end

	; BUGSY (2) - Rematch
	db "BUGSY@", TRAINERTYPE_ITEM_MOVES
	db 54, LEDIAN,     SILVERPOWDER,  BATON_PASS, LIGHT_SCREEN, REFLECT, COMET_PUNCH
	db 55, ARIADOS,    SILVERPOWDER,  SPIDER_WEB, SLUDGE_BOMB, GIGA_DRAIN, PSYCHIC_M
	db 56, PINSIR,     SILVERPOWDER,  SWORDS_DANCE, EARTHQUAKE, SUBMISSION, GUILLOTINE
	db 56, HERACROSS,  SILVERPOWDER,  MEGAHORN, EARTHQUAKE, REVERSAL, ENDURE
	db 58, SCIZOR,     METAL_COAT,    STEEL_WING, SLASH, SWORDS_DANCE, BATON_PASS
	db -1 ; end
...
MortyGroup:
	...
	db 23, HAUNTER,    HYPNOSIS, CURSE, NIGHT_SHADE, SHADOW_BALL
	db 24, MISDREAVUS, PSYWAVE, CONFUSE_RAY, MEAN_LOOK, PAIN_SPLIT
	db 25, HAUNTER,    SPITE, MEAN_LOOK, SHADOW_BALL, DREAM_EATER
	db 27, GENGAR,     HYPNOSIS, SHADOW_BALL, DREAM_EATER, DESTINY_BOND
	db -1 ; end

	; MORTY (2) - Rematch
	db "MORTY@", TRAINERTYPE_ITEM_MOVES
	db 54, MISDREAVUS, SPELL_TAG,     PERISH_SONG, MEAN_LOOK, SHADOW_BALL, THUNDERBOLT
	db 55, HAUNTER,    SPELL_TAG,     HYPNOSIS, DREAM_EATER, SHADOW_BALL, SLUDGE_BOMB
	db 56, GENGAR,     SPELL_TAG,     SHADOW_BALL, THUNDERBOLT, ICE_PUNCH, DESTINY_BOND
	db 56, GENGAR,     SPELL_TAG,     SHADOW_BALL, SLUDGE_BOMB, FIRE_PUNCH, HYPNOSIS
	db 58, GENGAR,     LEFTOVERS,     SHADOW_BALL, PSYCHIC_M, THUNDERBOLT, DESTINY_BOND
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 29, SEEL,       HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 30, DEWGONG,    ICY_WIND, AURORA_BEAM, TAKE_DOWN, ICE_BEAM
	db 31, JYNX,       LOVELY_KISS, POWDER_SNOW, DOUBLESLAP, ICE_PUNCH
	db 33, PILOSWINE,  ICY_WIND, FURY_ATTACK, EARTHQUAKE, BLIZZARD
	db -1 ; end

	; PRYCE (2) - Rematch
	db "PRYCE@", TRAINERTYPE_ITEM_MOVES
	db 54, DEWGONG,    NEVERMELTICE,  ICE_BEAM, SURF, SIGNAL_BEAM, REST
	db 55, CLOYSTER,   NEVERMELTICE,  ICE_BEAM, SURF, SPIKES, EXPLOSION
	db 56, JYNX,       NEVERMELTICE,  ICE_BEAM, PSYCHIC_M, LOVELY_KISS, DREAM_EATER
	db 56, LAPRAS,     NEVERMELTICE,  ICE_BEAM, SURF, THUNDERBOLT, CONFUSE_RAY
	db 58, PILOSWINE,  LEFTOVERS,     BLIZZARD, EARTHQUAKE, ROCK_SLIDE, CURSE
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_MOVES
	db 32, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, THUNDER_WAVE, SWIFT
	db 32, MAGNEMITE,  THUNDERBOLT, SONICBOOM, THUNDER_WAVE, LOCK_ON
	db 33, MAGNETON,   THUNDERBOLT, SUPERSONIC, TRI_ATTACK, THUNDER_WAVE
	db 36, STEELIX,    SCREECH, ROCK_SLIDE, IRON_TAIL, SANDSTORM
	db -1 ; end

	; JASMINE (2) - Rematch
	db "JASMINE@", TRAINERTYPE_ITEM_MOVES
	db 54, MAGNETON,   MAGNET,        THUNDERBOLT, THUNDER_WAVE, FLASH_CANNON, TRI_ATTACK
	db 55, MAGNETON,   MAGNET,        THUNDERBOLT, THUNDER_WAVE, FLASH_CANNON, EXPLOSION
	db 56, FORRETRESS, LEFTOVERS,     SPIKES, RAPID_SPIN, EARTHQUAKE, EXPLOSION
	db 56, SKARMORY,   LEFTOVERS,     STEEL_WING, DRILL_PECK, SPIKES, WHIRLWIND
	db 58, STEELIX,    METAL_COAT,    IRON_TAIL, EARTHQUAKE, ROCK_SLIDE, CRUNCH
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_MOVES
	db 29, PRIMEAPE,   KARATE_CHOP, RAGE, SEISMIC_TOSS, CROSS_CHOP
	db 29, HITMONTOP,  ROLLING_KICK, PURSUIT, RAPID_SPIN, TRIPLE_KICK
	db 32, POLIWRATH,  HYPNOSIS, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end

	; CHUCK (2) - Rematch
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 54, PRIMEAPE,   BLACKBELT_I,   CROSS_CHOP, EARTHQUAKE, ROCK_SLIDE, REVERSAL
	db 55, HITMONTOP,  BLACKBELT_I,   TRIPLE_KICK, EARTHQUAKE, ROCK_SLIDE, RAPID_SPIN
	db 56, HITMONLEE,  BLACKBELT_I,   HI_JUMP_KICK, EARTHQUAKE, REVERSAL, ENDURE
	db 56, HITMONCHAN, BLACKBELT_I,   DYNAMICPUNCH, ICE_PUNCH, THUNDER_PUNCH, MACH_PUNCH
	db 58, POLIWRATH,  LEFTOVERS,     DYNAMICPUNCH, SURF, ICE_BEAM, HYPNOSIS
	db -1 ; end
...
ClairGroup:
	...
	db 39, GYARADOS,   RAIN_DANCE, SURF, DRAGON_RAGE, HYPER_BEAM
	db 42, KINGDRA,    SMOKESCREEN, SURF, DRAGONBREATH, HYPER_BEAM
	db -1 ; end

	; CLAIR (2) - Rematch
	db "CLAIR@", TRAINERTYPE_ITEM_MOVES
	db 54, DRAGONAIR,  DRAGON_FANG,   OUTRAGE, SURF, THUNDERBOLT, FIRE_BLAST
	db 55, DRAGONITE,  DRAGON_FANG,   DRAGON_PULSE, EARTHQUAKE, FIRE_PUNCH, THUNDER_PUNCH
	db 56, GYARADOS,   MYSTIC_WATER,  HYDRO_PUMP, DRAGON_DANCE, EARTHQUAKE, DRAGON_PULSE
	db 56, AERODACTYL, SHARP_BEAK,    BRAVE_BIRD, STEALTH_ROCK, ROCK_SLIDE, EARTHQUAKE
	db 58, KINGDRA,    LEFTOVERS,     SURF, ICE_BEAM, DRAGON_PULSE, SMOKESCREEN
	db -1 ; end
...
Rival1Group:
	...
	; RIVAL1 (7) - Ilex Forest (HGSS)
	db "?@", TRAINERTYPE_MOVES
	db 16, GASTLY,     LICK, SPITE, MEAN_LOOK, CURSE
	db 18, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 20, BAYLEEF,    GROWL, REFLECT, RAZOR_LEAF, POISONPOWDER
	db -1 ; end

	; RIVAL1 (8) - Ilex Forest (HGSS)
	db "?@", TRAINERTYPE_MOVES
	db 16, GASTLY,     LICK, SPITE, MEAN_LOOK, CURSE
	db 18, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 20, QUILAVA,    LEER, SMOKESCREEN, EMBER, QUICK_ATTACK
	db -1 ; end

	; RIVAL1 (9) - Ilex Forest (HGSS)
	db "?@", TRAINERTYPE_MOVES
	db 16, GASTLY,     LICK, SPITE, MEAN_LOOK, CURSE
	db 18, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 20, CROCONAW,   LEER, RAGE, WATER_GUN, BITE
	db -1 ; end

	; RIVAL1 (10) - Route 34 (HGSS)
	db "?@", TRAINERTYPE_MOVES
	db 18, HAUNTER,    LICK, SPITE, MEAN_LOOK, CURSE
...
WillGroup:
	...
	db 43, JYNX,       LOVELY_KISS, ICE_PUNCH, PSYCHIC_M, BLIZZARD
	db 43, EXEGGUTOR,  REFLECT, LEECH_SEED, PSYCHIC_M, SOLARBEAM
	db 43, SLOWBRO,    SURF, AMNESIA, PSYCHIC_M, ICE_BEAM
	db 41, GIRAFARIG,  STOMP, AGILITY, PSYBEAM, CRUNCH
	db 45, XATU,       FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M, NIGHT_SHADE
	db -1 ; end
...
BrunoGroup:
	...
	db 44, HITMONTOP,  PURSUIT, TRIPLE_KICK, DIG, DETECT
	db 44, HITMONLEE,  MIND_READER, HI_JUMP_KICK, FORESIGHT, REVERSAL
	db 44, HITMONCHAN, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	db 45, STEELIX,    EARTHQUAKE, SANDSTORM, ROCK_SLIDE, IRON_TAIL
	db 46, PRIMEAPE,   KARATE_CHOP, SEISMIC_TOSS, CROSS_CHOP, THRASH
	db 48, MACHAMP,    ROCK_SLIDE, EARTHQUAKE, VITAL_THROW, CROSS_CHOP
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_MOVES
	db 44, UMBREON,    CONFUSE_RAY, FAINT_ATTACK, MEAN_LOOK, MOONLIGHT
	db 44, VILEPLUME,  STUN_SPORE, SLUDGE_BOMB, MOONLIGHT, PETAL_DANCE
	db 45, MURKROW,    PURSUIT, FAINT_ATTACK, NIGHT_SHADE, MEAN_LOOK
	db 46, GENGAR,     SHADOW_BALL, CURSE, DESTINY_BOND, DREAM_EATER
	db 47, WEAVILE,    ICE_SHARD, QUICK_ATTACK, SLASH, BEAT_UP
	db 49, HOUNDOOM,   ROAR, PURSUIT, FLAMETHROWER, CRUNCH
	db -1 ; end

KogaGroup:
	; KOGA (1)
	db "KOGA@", TRAINERTYPE_MOVES
	db 42, ARIADOS,    SPIDER_WEB, BATON_PASS, GIGA_DRAIN, PSYCHIC_M
	db 43, VENOMOTH,   SUPERSONIC, GUST, PSYCHIC_M, TOXIC
	db 44, FORRETRESS, PROTECT, RAPID_SPIN, EXPLOSION, SPIKES
	db 44, MUK,        MINIMIZE, ACID_ARMOR, SLUDGE_BOMB, TOXIC
	db 45, TENTACRUEL, SURF, SLUDGE_BOMB, BARRIER, TOXIC
	db 47, CROBAT,     WING_ATTACK, CONFUSE_RAY, TOXIC, SLUDGE_BOMB
	db -1 ; end

ChampionGroup:
	; CHAMPION (1)
	db "LANCE@", TRAINERTYPE_MOVES
	db 46, GYARADOS,   DRAGON_DANCE, DRAGON_PULSE, SURF, HYPER_BEAM
	db 48, DRAGONITE,  THUNDER_WAVE, THUNDER, DRAGON_PULSE, HYPER_BEAM
	db 48, DRAGONITE,  THUNDER_WAVE, BLIZZARD, DRAGON_PULSE, HYPER_BEAM
	db 47, AERODACTYL, BRAVE_BIRD, STEALTH_ROCK, ROCK_SLIDE, EARTHQUAKE
	db 47, CHARIZARD,  FLAMETHROWER, DRAGON_DANCE, DRAGON_PULSE, EARTHQUAKE
	db 50, KINGDRA,    SURF, DRAGON_PULSE, ICE_BEAM, HYPER_BEAM
	db 52, DRAGONITE,  FIRE_BLAST, THUNDER, DRAGON_PULSE, HYPER_BEAM
	db -1 ; end

BrockGroup:
	; BROCK (1)
	db "BROCK@", TRAINERTYPE_MOVES
	db 42, GRAVELER,   DEFENSE_CURL, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db 42, RHYHORN,    FURY_ATTACK, SCARY_FACE, EARTHQUAKE, HORN_DRILL
	db 43, OMASTAR,    BITE, SURF, ANCIENTPOWER, SPIKE_CANNON
	db 43, KABUTOPS,   SLASH, SURF, ANCIENTPOWER, GIGA_DRAIN
	db 45, STEELIX,    EARTHQUAKE, ROCK_SLIDE, IRON_TAIL, SANDSTORM
	db -1 ; end

MistyGroup:
	; MISTY (1)
	db "MISTY@", TRAINERTYPE_MOVES
	db 44, GOLDUCK,    SURF, DISABLE, PSYCH_UP, PSYCHIC_M
	db 44, QUAGSIRE,   SURF, AMNESIA, EARTHQUAKE, RAIN_DANCE
	db 45, POLITOED,   SURF, PERISH_SONG, SWAGGER, RAIN_DANCE
	db 46, LAPRAS,     SURF, PERISH_SONG, BLIZZARD, BODY_SLAM
	db 49, STARMIE,    SURF, CONFUSE_RAY, RECOVER, PSYCHIC_M
	db -1 ; end
...
LtSurgeGroup:
	...
	db 44, MAGNETON,   LOCK_ON, TRI_ATTACK, THUNDER_WAVE, ZAP_CANNON
	db 44, ELECTRODE,  SCREECH, LIGHT_SCREEN, SWIFT, EXPLOSION
	db 46, RAICHU,     THUNDER_WAVE, QUICK_ATTACK, THUNDERBOLT, THUNDER
	db 48, ELECTABUZZ, QUICK_ATTACK, THUNDERPUNCH, LIGHT_SCREEN, THUNDER
	db -1 ; end
...
ErikaGroup:
	...
	db 44, TANGELA,    VINE_WHIP, BIND, GIGA_DRAIN, SLEEP_POWDER
	db 44, JUMPLUFF,   MEGA_DRAIN, LEECH_SEED, COTTON_SPORE, SLEEP_POWDER
	db 45, VICTREEBEL, SUNNY_DAY, ACID, RAZOR_LEAF, SLUDGE_BOMB
	db 46, VILEPLUME,  STUN_SPORE, SLUDGE_BOMB, MOONLIGHT, PETAL_DANCE
	db 48, BELLOSSOM,  SUNNY_DAY, SYNTHESIS, PETAL_DANCE, SOLARBEAM
	db -1 ; end
...
JanineGroup:
	...
	db 38, CROBAT,     WING_ATTACK, CONFUSE_RAY, TOXIC, SLUDGE_BOMB
	db 38, WEEZING,    SLUDGE_BOMB, SMOKESCREEN, TOXIC, EXPLOSION
	db 38, WEEZING,    SLUDGE_BOMB, HAZE, TOXIC, DESTINY_BOND
	db 39, ARIADOS,    SPIDER_WEB, GIGA_DRAIN, PSYCHIC_M, SLUDGE_BOMB
	db 40, TENTACRUEL, SURF, SLUDGE_BOMB, BARRIER, TOXIC
	db 42, VENOMOTH,   GUST, PSYCHIC_M, TOXIC, SLUDGE_BOMB
	db -1 ; end
...
SabrinaGroup:
	...
	db 46, ESPEON,     QUICK_ATTACK, SWIFT, PSYBEAM, PSYCHIC_M
	db 46, MR__MIME,   BARRIER, REFLECT, BATON_PASS, PSYCHIC_M
	db 47, JYNX,       LOVELY_KISS, ICE_PUNCH, PSYCHIC_M, BLIZZARD
	db 48, EXEGGUTOR,  LEECH_SEED, EGG_BOMB, PSYCHIC_M, SOLARBEAM
...
Rival2Group:
	...
	; RIVAL2 (4)
	db "?@", TRAINERTYPE_MOVES
	db 45, WEAVILE,    QUICK_ATTACK, SCREECH, FAINT_ATTACK, ICICLE_CRASH
	db 48, CROBAT,     TOXIC, BITE, CONFUSE_RAY, WING_ATTACK
	db 45, MAGNEZONE,  THUNDER, FLASH_CANNON, THUNDER_WAVE, SWIFT
	db 46, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, WILL_O_WISP
	...
	; RIVAL2 (5)
	db "?@", TRAINERTYPE_MOVES
	db 45, WEAVILE,    QUICK_ATTACK, DARK_PULSE, FAINT_ATTACK, ICICLE_CRASH
	db 48, CROBAT,     TOXIC, BITE, CONFUSE_RAY, WING_ATTACK
	db 45, MAGNEZONE,  THUNDER, FLASH_CANNON, THUNDER_WAVE, SWIFT
	db 46, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, WILL_O_WISP
	db 46, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, TYPHLOSION, WILL_O_WISP, QUICK_ATTACK, FIRE_BLAST, SWIFT
	db -1 ; end
	...
	db 46, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, WILL_O_WISP
	db 46, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, FERALIGATR, SURF, RAIN_DANCE, SCALD, SCREECH
	db -1 ; end

	; RIVAL2 (7) - Post-game Rematch 1 (Meganium)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 55, WEAVILE,    NEVERMELTICE,  ICICLE_CRASH, DARK_PULSE, ICE_SHARD, KNOCK_OFF
	db 56, CROBAT,     SHARP_BEAK,    BRAVE_BIRD, TOXIC, U_TURN, CONFUSE_RAY
	db 55, MAGNEZONE,  MAGNET,        FLASH_CANNON, THUNDERBOLT, THUNDER_WAVE, TRI_ATTACK
	db 56, GENGAR,     SPELL_TAG,     SHADOW_BALL, WILL_O_WISP, SLUDGE_WAVE, THUNDERBOLT
	db 56, ALAKAZAM,   TWISTEDSPOON,  PSYCHIC_M, SHADOW_BALL, RECOVER, REFLECT
	db 58, MEGANIUM,   MIRACLE_SEED,  GIGA_DRAIN, BODY_SLAM, SYNTHESIS, LIGHT_SCREEN
	db -1 ; end

	; RIVAL2 (8) - Post-game Rematch 1 (Typhlosion)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 55, WEAVILE,    NEVERMELTICE,  ICICLE_CRASH, DARK_PULSE, ICE_SHARD, KNOCK_OFF
	db 56, CROBAT,     SHARP_BEAK,    BRAVE_BIRD, TOXIC, U_TURN, CONFUSE_RAY
	db 55, MAGNEZONE,  MAGNET,        FLASH_CANNON, THUNDERBOLT, THUNDER_WAVE, TRI_ATTACK
	db 56, GENGAR,     SPELL_TAG,     SHADOW_BALL, WILL_O_WISP, SLUDGE_WAVE, THUNDERBOLT
	db 56, ALAKAZAM,   TWISTEDSPOON,  PSYCHIC_M, SHADOW_BALL, RECOVER, REFLECT
	db 58, TYPHLOSION, CHARCOAL,      FIRE_BLAST, WILL_O_WISP, THUNDERPUNCH, EARTHQUAKE
	db -1 ; end

	; RIVAL2 (9) - Post-game Rematch 1 (Feraligatr)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 55, WEAVILE,    NEVERMELTICE,  ICICLE_CRASH, DARK_PULSE, ICE_SHARD, KNOCK_OFF
	db 56, CROBAT,     SHARP_BEAK,    BRAVE_BIRD, TOXIC, U_TURN, CONFUSE_RAY
	db 55, MAGNEZONE,  MAGNET,        FLASH_CANNON, THUNDERBOLT, THUNDER_WAVE, TRI_ATTACK
	db 56, GENGAR,     SPELL_TAG,     SHADOW_BALL, WILL_O_WISP, SLUDGE_WAVE, THUNDERBOLT
	db 56, ALAKAZAM,   TWISTEDSPOON,  PSYCHIC_M, SHADOW_BALL, RECOVER, REFLECT
	db 58, FERALIGATR, MYSTIC_WATER,  SURF, SCALD, ICE_PUNCH, EARTHQUAKE
	db -1 ; end

	; RIVAL2 (10) - Post-game Rematch 2 (Meganium)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 60, WEAVILE,    NEVERMELTICE,  ICICLE_CRASH, DARK_PULSE, ICE_SHARD, KNOCK_OFF
	db 61, CROBAT,     SHARP_BEAK,    BRAVE_BIRD, TOXIC, U_TURN, ROOST
	db 60, MAGNEZONE,  MAGNET,        FLASH_CANNON, THUNDERBOLT, THUNDER_WAVE, FLASH
	db 61, GENGAR,     SPELL_TAG,     SHADOW_BALL, WILL_O_WISP, SLUDGE_WAVE, THUNDERBOLT
	db 61, ALAKAZAM,   TWISTEDSPOON,  PSYCHIC_M, SHADOW_BALL, RECOVER, CALM_MIND
	db 63, MEGANIUM,   MIRACLE_SEED,  GIGA_DRAIN, BODY_SLAM, SYNTHESIS, LIGHT_SCREEN
	db -1 ; end

	; RIVAL2 (11) - Post-game Rematch 2 (Typhlosion)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 60, WEAVILE,    NEVERMELTICE,  ICICLE_CRASH, DARK_PULSE, ICE_SHARD, KNOCK_OFF
	db 61, CROBAT,     SHARP_BEAK,    BRAVE_BIRD, TOXIC, U_TURN, ROOST
	db 60, MAGNEZONE,  MAGNET,        FLASH_CANNON, THUNDERBOLT, THUNDER_WAVE, FLASH
	db 61, GENGAR,     SPELL_TAG,     SHADOW_BALL, WILL_O_WISP, SLUDGE_WAVE, THUNDERBOLT
	db 61, ALAKAZAM,   TWISTEDSPOON,  PSYCHIC_M, SHADOW_BALL, RECOVER, CALM_MIND
	db 63, TYPHLOSION, CHARCOAL,      FIRE_BLAST, WILL_O_WISP, THUNDERPUNCH, EARTHQUAKE
	db -1 ; end

	; RIVAL2 (12) - Post-game Rematch 2 (Feraligatr)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 60, WEAVILE,    NEVERMELTICE,  ICICLE_CRASH, DARK_PULSE, ICE_SHARD, KNOCK_OFF
	db 61, CROBAT,     SHARP_BEAK,    BRAVE_BIRD, TOXIC, U_TURN, ROOST
	db 60, MAGNEZONE,  MAGNET,        FLASH_CANNON, THUNDERBOLT, THUNDER_WAVE, FLASH
	db 61, GENGAR,     SPELL_TAG,     SHADOW_BALL, WILL_O_WISP, SLUDGE_WAVE, THUNDERBOLT
	db 61, ALAKAZAM,   TWISTEDSPOON,  PSYCHIC_M, SHADOW_BALL, RECOVER, CALM_MIND
	db 63, FERALIGATR, MYSTIC_WATER,  SURF, SCALD, ICE_PUNCH, EARTHQUAKE
	db -1 ; end

	; RIVAL2 (13) - Post-game Rematch 3 (Meganium)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 65, WEAVILE,    NEVERMELTICE,  ICICLE_CRASH, DARK_PULSE, ICE_SHARD, KNOCK_OFF
	db 66, CROBAT,     SHARP_BEAK,    BRAVE_BIRD, TOXIC, U_TURN, ROOST
	db 65, MAGNEZONE,  MAGNET,        FLASH_CANNON, THUNDERBOLT, THUNDER_WAVE, FLASH
	db 66, GENGAR,     SPELL_TAG,     SHADOW_BALL, WILL_O_WISP, SLUDGE_WAVE, THUNDERBOLT
	db 66, ALAKAZAM,   TWISTEDSPOON,  PSYCHIC_M, SHADOW_BALL, RECOVER, CALM_MIND
	db 68, MEGANIUM,   MIRACLE_SEED,  GIGA_DRAIN, BODY_SLAM, SYNTHESIS, LIGHT_SCREEN
	db -1 ; end

	; RIVAL2 (14) - Post-game Rematch 3 (Typhlosion)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 65, WEAVILE,    NEVERMELTICE,  ICICLE_CRASH, DARK_PULSE, ICE_SHARD, KNOCK_OFF
	db 66, CROBAT,     SHARP_BEAK,    BRAVE_BIRD, TOXIC, U_TURN, ROOST
	db 65, MAGNEZONE,  MAGNET,        FLASH_CANNON, THUNDERBOLT, THUNDER_WAVE, FLASH
	db 66, GENGAR,     SPELL_TAG,     SHADOW_BALL, WILL_O_WISP, SLUDGE_WAVE, THUNDERBOLT
	db 66, ALAKAZAM,   TWISTEDSPOON,  PSYCHIC_M, SHADOW_BALL, RECOVER, CALM_MIND
	db 68, TYPHLOSION, CHARCOAL,      FIRE_BLAST, WILL_O_WISP, THUNDERPUNCH, EARTHQUAKE
	db -1 ; end

	; RIVAL2 (15) - Post-game Rematch 3 (Feraligatr)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 65, WEAVILE,    NEVERMELTICE,  ICICLE_CRASH, DARK_PULSE, ICE_SHARD, KNOCK_OFF
	db 66, CROBAT,     SHARP_BEAK,    BRAVE_BIRD, TOXIC, U_TURN, ROOST
	db 65, MAGNEZONE,  MAGNET,        FLASH_CANNON, THUNDERBOLT, THUNDER_WAVE, FLASH
	db 66, GENGAR,     SPELL_TAG,     SHADOW_BALL, WILL_O_WISP, SLUDGE_WAVE, THUNDERBOLT
	db 66, ALAKAZAM,   TWISTEDSPOON,  PSYCHIC_M, SHADOW_BALL, RECOVER, CALM_MIND
	db 68, FERALIGATR, MYSTIC_WATER,  SURF, SCALD, ICE_PUNCH, EARTHQUAKE
	db -1 ; end
...
BlaineGroup:
	...
	db 47, MAGCARGO,   CURSE, FLAMETHROWER, ROCK_SLIDE, BODY_SLAM
	db 47, MAGMAR,     THUNDERPUNCH, FIRE_PUNCH, SUNNY_DAY, FLAMETHROWER
	db 48, ARCANINE,   EXTREMESPEED, FLAMETHROWER, CRUNCH, FIRE_BLAST
	db 49, FLAREON,    QUICK_ATTACK, FIRE_SPIN, BITE, FLAMETHROWER
	db 51, RAPIDASH,   QUICK_ATTACK, FIRE_SPIN, AGILITY, FIRE_BLAST
	db -1 ; end
...
ExecutiveMGroup:
	; EXECUTIVEM (1) - Archer (Dark/Fire specialist)
	db "ARCHER@", TRAINERTYPE_MOVES
	db 35, HOUNDOUR,   EMBER, ROAR, BITE, FAINT_ATTACK
	db 36, MURKROW,    PURSUIT, FAINT_ATTACK, HAZE, NIGHT_SHADE
	db 37, WEEZING,    SLUDGE_BOMB, SMOKESCREEN, TOXIC, EXPLOSION
	db 38, HOUNDOOM,   FLAMETHROWER, CRUNCH, FAINT_ATTACK, ROAR
	db -1 ; end

	; EXECUTIVEM (2) - Proton (Flying/Poison specialist)
	db "PROTON@", TRAINERTYPE_MOVES
	db 38, GOLBAT,     WING_ATTACK, BITE, CONFUSE_RAY, TOXIC
	db 39, WEEZING,    SLUDGE_BOMB, TOXIC, SMOKESCREEN, EXPLOSION
	db 39, FEAROW,     DRILL_PECK, PURSUIT, MIRROR_MOVE, AGILITY
	db 41, CROBAT,     WING_ATTACK, SLUDGE_BOMB, TOXIC, CONFUSE_RAY
	db -1 ; end

	; EXECUTIVEM (3) - Petrel (Disguise/Trickster specialist)
	db "PETREL@", TRAINERTYPE_MOVES
	db 32, KOFFING,    SLUDGE, SMOKESCREEN, TOXIC, SELFDESTRUCT
	db 33, GRIMER,     SLUDGE, MINIMIZE, ACID_ARMOR, TOXIC
	db 33, WEEZING,    SLUDGE_BOMB, SMOKESCREEN, TOXIC, EXPLOSION
	db 34, MUK,        SLUDGE_BOMB, MINIMIZE, ACID_ARMOR, TOXIC
	db 34, ELECTRODE,  SWIFT, SCREECH, LIGHT_SCREEN, EXPLOSION
	db -1 ; end

	; EXECUTIVEM (4) - Early game executive
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 24, ZUBAT,      LEECH_LIFE, BITE, SUPERSONIC, CONFUSE_RAY
	db 25, RATICATE,   QUICK_ATTACK, HYPER_FANG, PURSUIT, SCARY_FACE
	db 24, GRIMER,     SLUDGE, MINIMIZE, POISON_GAS, DISABLE
	db 26, KOFFING,    SLUDGE, SMOKESCREEN, TOXIC, SELFDESTRUCT
	db -1 ; end
...
ExecutiveFGroup:
	; EXECUTIVEF (1) - Ariana (Poison/Grass specialist)
	db "ARIANA@", TRAINERTYPE_MOVES
	db 34, ARBOK,      WRAP, POISON_STING, BITE, GLARE
	db 35, VILEPLUME,  STUN_SPORE, SLUDGE_BOMB, SLEEP_POWDER, PETAL_DANCE
	db 36, VICTREEBEL, RAZOR_LEAF, ACID, SLEEP_POWDER, WRAP
	db 37, CROBAT,     WING_ATTACK, CONFUSE_RAY, TOXIC, BITE
	db -1 ; end

	; EXECUTIVEF (2) - Ariana (Early encounter)
	db "ARIANA@", TRAINERTYPE_MOVES
	db 25, ARBOK,      WRAP, POISON_STING, BITE, GLARE
	db 25, GLOOM,      ABSORB, SWEET_SCENT, SLEEP_POWDER, ACID
	db 26, GOLBAT,     LEECH_LIFE, BITE, SUPERSONIC, CONFUSE_RAY
	db 27, VILEPLUME,  STUN_SPORE, MEGA_DRAIN, SLEEP_POWDER, ACID
	db -1 ; end
...
RedGroup:
	...
	db 81, PIKACHU,    LIGHT_BALL,    THUNDERBOLT, THUNDER, QUICK_ATTACK, IRON_TAIL
	db 73, ESPEON,     TWISTEDSPOON,  PSYCHIC_M, MORNING_SUN, SHADOW_BALL, BITE
	db 75, SNORLAX,    LEFTOVERS,     BODY_SLAM, EARTHQUAKE, REST, CURSE
	db 77, VENUSAUR,   MIRACLE_SEED,  SOLARBEAM, SLUDGE_WAVE, SYNTHESIS, EARTHQUAKE
	db 77, CHARIZARD,  CHARCOAL,      FLAMETHROWER, DRAGON_DANCE, BRAVE_BIRD, DRAGON_PULSE
	db 77, BLASTOISE,  MYSTIC_WATER,  SCALD, ICE_BEAM, EARTHQUAKE, RAIN_DANCE
	db -1 ; end

BlueGroup:
	; BLUE (1)
	db "BLUE@", TRAINERTYPE_MOVES
	db 56, PIDGEOT,    BRAVE_BIRD, WHIRLWIND, WING_ATTACK, MIRROR_MOVE
	db 56, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 56, RHYPERIOR,  STEALTH_ROCK, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
	db 58, GYARADOS,   DRAGON_DANCE, DRAGON_PULSE, SCALD, HYPER_BEAM
	db 58, EXEGGUTOR,  SUNNY_DAY, LEECH_SEED, PSYCHIC_M, SOLARBEAM
	db 58, ARCANINE,   EXTREMESPEED, FLAMETHROWER, WILL_O_WISP, FIRE_BLAST
	db -1 ; end
