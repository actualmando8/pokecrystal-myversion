...
ChampionGroup:
	...
	db 46, GYARADOS,   DRAGON_DANCE, RAIN_DANCE, SURF, HYPER_BEAM
	db 48, DRAGONITE,  THUNDER_WAVE, THUNDER, OUTRAGE, HYPER_BEAM
	db 48, DRAGONITE,  THUNDER_WAVE, BLIZZARD, OUTRAGE, HYPER_BEAM
	db 47, AERODACTYL, WING_ATTACK, ANCIENTPOWER, ROCK_SLIDE, EARTHQUAKE
	db 47, CHARIZARD,  FLAMETHROWER, WING_ATTACK, DRAGON_CLAW, EARTHQUAKE
	db 50, KINGDRA,    SURF, DRAGONBREATH, ICE_BEAM, HYPER_BEAM
	db 52, DRAGONITE,  FIRE_BLAST, THUNDER, OUTRAGE, HYPER_BEAM
	db -1 ; end
...
BlueGroup:
	...
	db 58, GYARADOS,   DRAGON_DANCE, HYDRO_PUMP, RAIN_DANCE, HYPER_BEAM
	db 58, EXEGGUTOR,  SUNNY_DAY, LEECH_SEED, PSYCHIC_M, SOLARBEAM
	db 58, ARCANINE,   EXTREMESPEED, FLAMETHROWER, CRUNCH, FIRE_BLAST
	db -1 ; end
