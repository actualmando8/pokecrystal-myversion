...
MonMenuIcons:
	...
	db ICON_LAPRAS      ; AZURILL
	db ICON_MONSTER     ; CLODSIRE
	db ICON_STARYU      ; CORSOLA_G
	db ICON_STARYU      ; CURSOLA
	db ICON_SERPENT     ; DUDUNSPARCE
	db ICON_EQUINE      ; FARIGIRAF
	db ICON_CLEFAIRY    ; GLISCOR
	db ICON_BUG         ; KLEAVOR
	db ICON_MONSTER     ; LICKILICKY
	db ICON_BIRD        ; MANTYKE
	db ICON_CLEFAIRY    ; MIME_JR
	db ICON_FOX         ; NINETALES_A
	db ICON_FISH        ; OVERQWIL
	db ICON_FOX         ; VULPIX_A
	db ICON_FISH        ; WOOPER_P
